        ...
        <table className="recruitment-table">
          ...
          <tbody>
            <tr>
              <td>Air Seoul</td>
              <td>상시 모집</td>
              <td>2024 에어서울 객실승무원 신입 채용</td>
            </tr>

            <tr>
              <td>Emirates Airline</td>
              <td>~3/23</td>
              <td>2024 에미레이트 항공 객실승무원 채용공고</td>
            </tr>

            <tr>
              <td>Cathay Pacific</td>
              <td>~3/31</td>
              <td>2024 상반기 케세이퍼시픽 승무원 채용공고</td>
            </tr>

            <tr>
              <td>Singapore Airlines</td>
              <td>~6/2</td>
              <td>2024 상반기 싱가폴 항공 채용공고</td>
            </tr>

            <tr>
              <td>Jin Air</td>
              <td>~2/23</td>
              <td>2024년 상반기 진에어 객실승무원 신입 모집</td>
            </tr>

            <tr>
              <td>t'way Airlines</td>
              <td>~2/29</td>
              <td>2024년 상반기 티웨이항공 채용 공고</td>
            </tr>
